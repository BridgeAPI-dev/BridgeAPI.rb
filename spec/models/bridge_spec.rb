...
RSpec.describe Bridge, type: :model do
  ...
  it 'has many env vars' do 
    ...
    bridge.env_vars << EnvVar.create(key: 'database', value: 'a102345ij2')
    bridge.env_vars << EnvVar.create(key: 'database_password', value: 'supersecretpasswordwow')
  ...
  it 'has many events' do 
    ...
    bridge.events << Event.create(completed: false, outboundURL: bridge.outboundURL, inboundURL: bridge.inboundURL, data: '', status_code: 300)
    bridge.events << Event.create(completed: false, outboundURL: bridge.outboundURL, inboundURL: bridge.inboundURL, data: '', status_code: 300)
    bridge.events << Event.create(completed: false, outboundURL: bridge.outboundURL, inboundURL: bridge.inboundURL, data: '', status_code: 300)
    bridge.events << Event.create(completed: false, outboundURL: bridge.outboundURL, inboundURL: bridge.inboundURL, data: '', status_code: 300)
    bridge.events << Event.create(completed: false, outboundURL: bridge.outboundURL, inboundURL: bridge.inboundURL, data: '', status_code: 300)
